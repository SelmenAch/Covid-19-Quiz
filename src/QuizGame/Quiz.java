...
public class Quiz extends JFrame {
	...
	public void afficherResultat(){
		JLabel[] msg = {new JLabel("Thanks for playing! Your quiz results :"),
						new JLabel("\n"),
						new JLabel("Incorrect Answers : "+nbEchecs),
						new JLabel("Correct Answers : "+(total-nbEchecs)),
						new JLabel("Quiz Points : "+(total- 2 * nbEchecs))			
		};
